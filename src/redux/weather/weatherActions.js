...
export const fetchWeather = city => {
    return (dispatch) => {
        ...
        axios.get('http://api.openweathermap.org/data/2.5/weather?q=' + city + '&APPID=ca4681885056a937b5ff8c7900747249')
        .then(response => {
            ...
            axios.get('http://api.openweathermap.org/data/2.5/forecast?q=' + city +'&appid=ca4681885056a937b5ff8c7900747249')
            .then(response => {
